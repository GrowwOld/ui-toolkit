...
class InnerSlider extends React.Component {
  ...
  componentDidMount = () => {
    ...
    Array.prototype.forEach.call(
      document.querySelectorAll(".carousel14Slide"),
      slide => {
  ...
  checkImagesLoad = () => {
    let images = this.list.querySelectorAll(".carousel14Slide img");
  ...
  render = () => {
    let className = classnames("carousel14Slider", this.props.className, {
      "carousel14Vertical": this.props.vertical,
      "carousel14Initialized": true
    });
    ...
    if (this.props.unslick) {
      listProps = { className: "carousel14List" };
