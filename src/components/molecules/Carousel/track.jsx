...
const getSlideClasses = spec => {
  ...
  return {
    "carousel14Slide": true,
    "carousel14Active": slickActive,
    "carousel-center": slickCenter,
    "carousel-cloned": slickCloned,
    "carousel-current": slickCurrent // dubious in case of RTL
  };
};
  ...
  React.Children.forEach(spec.children, (elem, index) => {
    ...
    slides.push(
      React.cloneElement(child, {
        ...
        tabIndex: "-1",
        "aria-hidden": !slideClasses[ "carousel14Active" ],
